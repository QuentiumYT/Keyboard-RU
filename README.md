<h1 align="center" style="font-size: 50px;">Welcome to Keyboard-RU project 👋</h1>
...
**WINDOWS:** Simply click twice on `Keyboard-RU.pyw` or run using IDLE

**LINUX:** Not tested yet for GUIs
```bash
python3 Keyboard-RU.pyw
```
